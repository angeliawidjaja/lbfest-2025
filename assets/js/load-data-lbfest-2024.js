import dataLBFest2024 from '../json/tenants-lbfest-2024.json' with { type: 'json' };
...
const tenantCategorySection = document.getElementById('list-tenant-category-lbfest-2024');

let tenantCategoryHtmlContent = '<li data-filter="*" class="filter-active">All</li>';
dataLBFest2024.forEach(tenant => {
...
// Start List Tenant
const tenantItemsSection = document.getElementById('list-tenant-item-lbfest-2024');

let tenantItemsHtmlContent = '';
dataLBFest2024.forEach(tenantCategoryObj => {
    ...
    tenantItemsHtmlContent += `<div class="col-lg-2 col-md-6 tenant-item isotope-item filter-${tenantCategoryObj.tenantCategory}">
              <div class="tenant-card">
                ...
                <div class="tenant-info">
                  <p>${tenantItem.brandCategory} ${tenantItem.no}</p>
                  <p>${tenantItem.brandSerialCode}</p>
